<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <x-navbars.navs.auth titlePage="الاقسام"></x-navbars.navs.auth>
                    ...
                    <div class="card my-4">
                        ...
                        <div class=" me-3 my-3 text-end">
                            <a class="btn bg-gradient-dark mb-0" href="{{ route('categories.create') }}"><i
                                    class="material-icons text-sm">add</i>&nbsp;&nbsp;إضافة قسم جديد</a>
                        </div>
                                    ...
                                    @foreach($categories as $cat)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <a href="{{ asset('storage/' .$cat->image) }}">
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <p class="mb-0 text-sm">{{ $cat->name }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <a rel="tooltip" class="btn btn-success btn-link"
                                                   href="{{ route('categories.edit' , $cat->id) }}" data-original-title=""
                                                   title="">
